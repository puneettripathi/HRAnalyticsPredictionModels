...
setwd("C:/Users/Melvin/Downloads/PA-I_Case_Study_HR_Analytics")
...
employeeHr <- employeeHr[, !(colnames(employeeHr) %in% c('Age','NumCompaniesWorked', "YearsSinceLastPromotion", "YearsWithCurrManager", "YearsAtCompany", "incomegroup"))]

##### Outlier treatment for contiuous variables #####
list_of_num_cols <- c("DistanceFromHome", "MonthlyIncome", "PercentSalaryHike", "avg_workhours_per_week", "Num_of_days_off")
...
factor_Variables <- c("WorkYearSeg", "CompanyYearSeg", "CurrentMgrTimeSeg", "LastPromotionSeg", "TrainingTimesLastYear", "AgeGroup", "CmpWorkGroup", "EnvironmentSatisfaction", "JobSatisfaction", "WorkLifeBalance", "BusinessTravel", "Department", "Education", "EducationField", "Gender", "JobLevel", "JobRole", "MaritalStatus", "StockOptionLevel", "JobInvolvement", "PerformanceRating", "overtime" )
fact_table <- employeeHr[,factor_Variables]
fact_table$TrainingTimesLastYear <- as.factor(fact_table$TrainingTimesLastYear)
...
model_3 <- glm(formula = Attrition ~ avg_workhours_per_week + Num_of_days_off + 
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
                 AgeGroup.x41_50 + AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                 CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
                 ...
                 JobLevel.x5 + JobRole.xManager + JobRole.xManufacturing.Director + 
                 JobRole.xSales.Representative + 
                 MaritalStatus.xMarried + MaritalStatus.xSingle + StockOptionLevel.x1 + 
                 JobInvolvement.x3 + overtime, family = "binomial", data = train)
summary(model_3)
vif(model_3)

model_4 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_5 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_6 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_7 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_8 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_9 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                 WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                 WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                 CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                 LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_10 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_11 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_12 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_13 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
...
model_14 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x5 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                  CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
                  EnvironmentSatisfaction.x3 + EnvironmentSatisfaction.x4 + 
                  JobSatisfaction.x2 + JobSatisfaction.x3 + JobSatisfaction.x4 + 
                  WorkLifeBalance.x2 + WorkLifeBalance.x3 + WorkLifeBalance.x4 + 
...
model_15 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + CurrentMgrTimeSeg.xover_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                  CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
                  EnvironmentSatisfaction.x3 + EnvironmentSatisfaction.x4 + 
                  JobSatisfaction.x2 + JobSatisfaction.x3 + JobSatisfaction.x4 + 
...
model_16 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                  CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
                  EnvironmentSatisfaction.x3 + EnvironmentSatisfaction.x4 + 
...
model_17 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
...
model_18 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
...
model_19 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  CompanyYearSeg.x6_8 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
...
model_20 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + CompanyYearSeg.x3_5 + 
                  LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                  CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
                  EnvironmentSatisfaction.x3 + EnvironmentSatisfaction.x4 + 
...
model_21 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                  CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
...
model_22 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
...
model_23 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
...
model_24 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
...
model_25 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
...
model_26 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
                  CmpWorkGroup.x6_8 + CmpWorkGroup.xover_8 + EnvironmentSatisfaction.x2 + 
                  EnvironmentSatisfaction.x3 + EnvironmentSatisfaction.x4 + JobSatisfaction.x4 + 
                  WorkLifeBalance.x2 + BusinessTravel.xTravel_Frequently + 
                  JobRole.xManufacturing.Director + MaritalStatus.xSingle, 
                family = "binomial", data = train)
summary(model_26)
vif(model_26)

model_27 <- glm(formula = Attrition ~ avg_workhours_per_week +  
                  WorkYearSeg.x12_15 + WorkYearSeg.x16_20 + WorkYearSeg.x4_7 + 
                  WorkYearSeg.x8_11 + WorkYearSeg.xover_21 + LastPromotionSeg.x6_9 + 
                  LastPromotionSeg.xover_9 + TrainingTimesLastYear.x6 + 
                  AgeGroup.xUnder_30 + CmpWorkGroup.x3_5 + 
